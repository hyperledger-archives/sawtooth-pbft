...
project = u'Sawtooth PBFT'
copyright = u'2018 Bitwise IO, Inc'
...
htmlhelp_basename = 'sawtooth-pbft'
...
latex_documents = [
    (master_doc, 'sawtooth-pbft.tex', u'Sawtooth PBFT Documentation',
...
man_pages = [
    (master_doc, 'bitwise', u'Sawtooth PBFT Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SawtoothPBFT', u'Sawtooth PBFT Documentation',
     author, 'SawtoothPBFT', 
     'Practical Byzantine Fault Tolerance for Hyperledger Sawtooth',
     'Miscellaneous'),
]
